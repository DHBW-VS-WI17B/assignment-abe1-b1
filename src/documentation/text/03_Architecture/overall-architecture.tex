...
Hierfür implementiert der Server neben dem Aktorensystem \textit{Thespian}\ifootcite{thespianpy_com} einen Webserver und stellt eine \ac{API} zur Verfügung. 
...
% Jeder Anwendungsfall hat seine eigene Route. -> Anwendungsfall "User hinzufügen" fehlt noch
