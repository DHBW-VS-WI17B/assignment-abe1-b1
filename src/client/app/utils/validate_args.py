...
class Validate_Args():
    ...
    def validate_args(args):
        ...
        schema = Schema({
            ...
            '--ticket-price': Or(None, And(Use(float)), error='The price of the tickets can only be a number. Please do not use currency symbols e.g. 5.60'),
            ...
            '--budget': Or(None, And(Use(float)), error='The customer budget can only be a number, please do not use currency symbols e.g. 5.60'),
